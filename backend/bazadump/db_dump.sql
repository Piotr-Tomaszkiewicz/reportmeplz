...
--
-- Current Database: `moja_baza_api`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `moja_baza_api` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
CREATE TABLE `Comments` (
  ...
  `FileId` longtext DEFAULT NULL,
  `FileName` longtext DEFAULT NULL,
  PRIMARY KEY (`Id`),
  KEY `IX_Comments_ReportId` (`ReportId`),
  KEY `IX_Comments_UserId` (`UserId`),
  CONSTRAINT `FK_Comments_Reports_ReportId` FOREIGN KEY (`ReportId`) REFERENCES `Reports` (`Id`) ON DELETE CASCADE,
...
CREATE TABLE `Reports` (
  ...
  `FileId` longtext DEFAULT NULL,
  `DateReported` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00.000000',
  `DateResolved` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`Id`),
  KEY `IX_Reports_AssigneeId` (`AssigneeId`),
  KEY `IX_Reports_ReporterId` (`ReporterId`),
  CONSTRAINT `FK_Reports_Users_AssigneeId` FOREIGN KEY (`AssigneeId`) REFERENCES `Users` (`Id`) ON DELETE SET NULL,
...
CREATE TABLE `Users` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_Users_LocationId` (`LocationId`),
  KEY `IX_Users_RoleId` (`RoleId`),
  CONSTRAINT `FK_Users_Locations_LocationId` FOREIGN KEY (`LocationId`) REFERENCES `Locations` (`Id`) ON DELETE CASCADE,
...
-- Dump completed on 2026-01-23 19:48:09
